...
namespace Com.Urbanairship {
	...
	[global::Android.Runtime.Register ("com/urbanairship/CoreReceiver", DoNotGenerateAcw=true)]
	public partial class CoreReceiver : global::Android.Content.BroadcastReceiver {

		internal static IntPtr java_class_handle;
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/urbanairship/CoreReceiver", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (CoreReceiver); }
		}

		protected CoreReceiver (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor;
		[Register (".ctor", "()V", "")]
		public CoreReceiver () : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (Handle != IntPtr.Zero)
				return;

			if (GetType () != typeof (CoreReceiver)) {
...
#pragma warning disable 0169
		...
		{
			CoreReceiver __this = Java.Lang.Object.GetObject<CoreReceiver> (native__this, JniHandleOwnership.DoNotTransfer);
