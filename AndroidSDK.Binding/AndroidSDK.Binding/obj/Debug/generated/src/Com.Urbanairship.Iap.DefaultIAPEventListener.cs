...
namespace Com.Urbanairship.Iap {
	...
	[global::Android.Runtime.Register ("com/urbanairship/iap/DefaultIAPEventListener", DoNotGenerateAcw=true)]
	public partial class DefaultIAPEventListener : global::Com.Urbanairship.Iap.IAPEventListener {

		internal static IntPtr java_class_handle;
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/urbanairship/iap/DefaultIAPEventListener", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (DefaultIAPEventListener); }
		}

		protected DefaultIAPEventListener (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor;
		[Register (".ctor", "()V", "")]
		public DefaultIAPEventListener () : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (Handle != IntPtr.Zero)
				return;

			if (GetType () != typeof (DefaultIAPEventListener)) {
...
#pragma warning disable 0169
		...
		{
			DefaultIAPEventListener __this = Java.Lang.Object.GetObject<DefaultIAPEventListener> (native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		public override void BillingSupported (bool p0)
		{
			...
			if (GetType () == ThresholdType)
				...
				JNIEnv.CallNonvirtualVoidMethod  (Handle, ThresholdClass, id_billingSupported_Z, new JValue (p0));
		}
...
#pragma warning restore 0169
		...
		public override void DownloadFailed (global::Com.Urbanairship.Iap.Product p0)
		{
			...
			if (GetType () == ThresholdType)
				...
				JNIEnv.CallNonvirtualVoidMethod  (Handle, ThresholdClass, id_downloadFailed_Lcom_urbanairship_iap_Product_, new JValue (p0));
		}
...
#pragma warning restore 0169
		...
		public override void DownloadProgress (global::Com.Urbanairship.Iap.Product p0, int p1)
		{
			...
			if (GetType () == ThresholdType)
				...
				JNIEnv.CallNonvirtualVoidMethod  (Handle, ThresholdClass, id_downloadProgress_Lcom_urbanairship_iap_Product_I, new JValue (p0), new JValue (p1));
		}
...
#pragma warning restore 0169
		...
		public override void DownloadStarted (global::Com.Urbanairship.Iap.Product p0, int p1)
		{
			...
			if (GetType () == ThresholdType)
				...
				JNIEnv.CallNonvirtualVoidMethod  (Handle, ThresholdClass, id_downloadStarted_Lcom_urbanairship_iap_Product_I, new JValue (p0), new JValue (p1));
		}
...
#pragma warning restore 0169
		...
		public override void DownloadSuccessful (global::Com.Urbanairship.Iap.Product p0)
		{
			...
			if (GetType () == ThresholdType)
				...
				JNIEnv.CallNonvirtualVoidMethod  (Handle, ThresholdClass, id_downloadSuccessful_Lcom_urbanairship_iap_Product_, new JValue (p0));
		}
...
#pragma warning restore 0169
		...
		public override void MarketUnavailable (global::Com.Urbanairship.Iap.Product p0)
		{
			...
			if (GetType () == ThresholdType)
				...
				JNIEnv.CallNonvirtualVoidMethod  (Handle, ThresholdClass, id_marketUnavailable_Lcom_urbanairship_iap_Product_, new JValue (p0));
		}
...
#pragma warning restore 0169
		...
		public override void RestoreStarted ()
		{
			...
			if (GetType () == ThresholdType)
				...
				JNIEnv.CallNonvirtualVoidMethod  (Handle, ThresholdClass, id_restoreStarted);
		}
