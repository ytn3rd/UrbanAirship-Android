...
namespace Com.Urbanairship.Iap.Marketinterface {
	...
	[global::Android.Runtime.Register ("com/urbanairship/iap/marketinterface/BillingReceiver", DoNotGenerateAcw=true)]
	public partial class BillingReceiver : global::Android.Content.BroadcastReceiver {

		internal static IntPtr java_class_handle;
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/urbanairship/iap/marketinterface/BillingReceiver", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (BillingReceiver); }
		}

		protected BillingReceiver (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor;
		[Register (".ctor", "()V", "")]
		public BillingReceiver () : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (Handle != IntPtr.Zero)
				return;

			if (GetType () != typeof (BillingReceiver)) {
...
#pragma warning disable 0169
		...
		{
			BillingReceiver __this = Java.Lang.Object.GetObject<BillingReceiver> (native__this, JniHandleOwnership.DoNotTransfer);
