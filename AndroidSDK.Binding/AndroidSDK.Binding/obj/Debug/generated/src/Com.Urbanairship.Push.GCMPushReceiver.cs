...
namespace Com.Urbanairship.Push {
	...
	[global::Android.Runtime.Register ("com/urbanairship/push/GCMPushReceiver", DoNotGenerateAcw=true)]
	public partial class GCMPushReceiver : global::Android.Content.BroadcastReceiver {

		internal static IntPtr java_class_handle;
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/urbanairship/push/GCMPushReceiver", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (GCMPushReceiver); }
		}

		protected GCMPushReceiver (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor;
		[Register (".ctor", "()V", "")]
		public GCMPushReceiver () : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (Handle != IntPtr.Zero)
				return;

			if (GetType () != typeof (GCMPushReceiver)) {
...
#pragma warning disable 0169
		...
		{
			GCMPushReceiver __this = Java.Lang.Object.GetObject<GCMPushReceiver> (native__this, JniHandleOwnership.DoNotTransfer);
